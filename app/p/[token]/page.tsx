...
const CONTENTS = [
  {
    ...
    name: '호흡연습',
    steps: [
      { text: '코로 천천히 들이쉬기', duration: 4 },
      { text: '잠깐 참기', duration: 2 },
  ...
  },
  {
    ...
    name: '구강운동',
    steps: [
      { text: '입술 오므리기 → 펴기', duration: 5 },
      { text: '혀 앞으로 내밀기 → 넣기', duration: 5 },
      { text: '혀 좌우로 움직이기', duration: 5 },
      { text: '볼 부풀리기 → 내보내기', duration: 5 },
    ],
    repeat: '각 10회 반복',
    caution: '천천히 정확하게',
  },
  {
    ...
    name: '조음교대운동',
    steps: [
      { text: '퍼퍼퍼퍼퍼', duration: 5 },
      { text: '터터터터터', duration: 5 },
      { text: '커커커커커', duration: 5 },
      { text: '라라라라라', duration: 5 },
      { text: '퍼터커  퍼터커', duration: 5 },
    ],
    repeat: '각 5회 반복',
    caution: '천천히 정확하게 발음',
  },
